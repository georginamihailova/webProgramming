...
public class TaskController {
     ...
     */
    @GetMapping({"/","/tasks"})
    public String showList(Model model, @RequestParam(required = false) Integer lessThanDayBeforeDueDate,@RequestParam(required = false) Long assigneeId)
    ...
    public String showAdd(Model model) {
        model.addAttribute("categories",TaskCategory.values());
        model.addAttribute("assignees",this.userService.listAll());
        return "form";
    }
